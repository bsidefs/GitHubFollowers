...
class GFUserInfoHeaderVC: UIViewController {
    ...
    let usernameLabel     = GFTitleLabel(aligned: .left, fontSize: 34)
    let nameLabel         = GFSecondaryTitleLabel(size: 18)
    
    let locationImageView = UIImageView()
    let locationLabel     = GFSecondaryTitleLabel(size: 16)
    
    let bioLabel          = GFBodyLabel(aligned: .left)
    ...
    func configureUIElementsToUser() {
